...
import sys
sys.path.insert(1, '/home/ec2-user/covid_data/covid_data')

oracle_date = np.datetime64('2020-12-05T00:00:00.00')
...
State_Data = StateDM.Data_Manager('/home/ec2-user/covid_data/COVID19_USTracking.csv')
...
df_last.to_pickle("state_oracle_kz.pkl", protocol=4)

flat_date = LastDate - np.timedelta64(10,'D')
flat_date = np.datetime64(flat_date)
df_kz = pd.DataFrame(columns = ['Country_Region','Date','Dt','DayOfWeek','Count',
...
df_kz.to_pickle("state_flat_kz.pkl", protocol=4)
#%% HRR
#HRR
'''
df = pd.DataFrame(columns = ['Country_Region','Date','Dt','DayOfWeek','count'])
HRR_Data = DMHRR.Data_Manager('/home/ec2-user/covid_data/HRR_county_agg.csv')
...
'''
df = pd.DataFrame(columns = ['Country_Region','Date','Dt','DayOfWeek','count'])
Sta6a_Data = DMSta6a.Data_Manager('/home/ec2-user/covid_data/Sta6a_county_agg.csv')
Sta6a_Data.Set_Min_Confirmed(10)
Sta6a_list = Sta6a_Data.Get_Available_Sta6a()
